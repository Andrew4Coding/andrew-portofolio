            ...
            <div
                ...
                <Reveal>
                    <div className="flex flex-col gap-5 lg:gap-5">
                        ...
                        <h1 className="text-xl lg:text-4xl font-bold text-center lg:text-left">Hello! from</h1>
                        ...
                        <p className="text-sm lg:text-md text-[#54555F] leading-loose text-center lg:text-left">
                            Undergraduate Computer Science Student at University of Indonesia | Interested in Website and Mobile Development
                        </p>

                        <motion.button 
                        whileTap={{scale: 0.90}}
                        className="bg-black p-4 lg:p-5 px-10 rounded-xl flex justify-center gap-5 w-full lg:w-fit duration-100 hover:scale-105">
                            <Image src={'/svg/download.svg'} alt="" width={20} height={20} className="fill-white" />
                            <span className="font-semibold text-white text-sm">Download CV</span>
                        </motion.button>
