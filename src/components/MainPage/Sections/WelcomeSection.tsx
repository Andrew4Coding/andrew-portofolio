...
export const WelcomeSection: React.FC = () => {
    return (
        <section className="flex h-screen w-full p-10 sm:p-24 lg:p-28 items-center justify-center" id='welcome'>
            <Reveal className="flex items-center flex-col gap-5 lg:gap-5 text-white">
                <div className="flex justify-center duration-100 hover:scale-110">
                    <Image src={'/images/me.jpg'} alt="" width={100} height={100} className="object-cover w-28 aspect-square shadow- rounded-full object-center"></Image>
                </div>
                ...
                <motion.button
                    whileTap={{ scale: 0.90 }}
                    className="bg-white p-4 lg:p-5 px-10 rounded-xl flex justify-center gap-5 w-full duration-100 hover:scale-105">
